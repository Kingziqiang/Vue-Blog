  ...
  <div class="container">
   <!--  <section id="welcome">
     Welcome to my blog
		...
		<section class="newArticles posts animated fadeIn" >
          ...
          <div class="box" >
              ...
              <div class="art_footer"> 
                ...
                <router-link :to="{ name: 'article', params:{aid: article._id} }" class="detail">read more>></router-link>
              </div> 
  			   </div>       
      </div>
		</section>
   <router-link to="/articles">更多文章......</router-link>
	</div>
</template>
